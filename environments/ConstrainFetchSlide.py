...
class ConstrainFetchSlide(FetchSlideEnv):
    '''This class is made to get consistent initial observation every time it resets.'''

    environment_name = "Fetch-Slide-Constrained-v1"
...
if __name__ == "__main__":
    ...
    print("-----------------------------")
    env_2 = ConstrainFetchSlide(constrain = 'Fix', initial_info = initial_info_1)
    info = env_2.reset()
    trigger = True
    for i in range(100):
        info_1 = info
    ...
    print("-----------------------------")
    env_3 = ConstrainFetchSlide(constrain = 'Gaussian', initial_info = initial_info_1)
    info = env_3.reset()
    trigger = True
    for i in range(100):
        info_1 = info
